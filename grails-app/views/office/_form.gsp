...
<div class="fieldcontain ${hasErrors(bean: officeInstance, field: 'section', 'error')} ">
	<label for="section">
...
<div class="fieldcontain ${hasErrors(bean: officeInstance, field: 'subDivisionOffice', 'error')} required">
	...
	<g:select id="subDivisionOffice" name="subDivisionOffice.id" from="${com.rrmis.SubDivisionOffice.list()}" optionKey="id" required="" value="${officeInstance?.subDivisionOffice?.id}" class="many-to-one"/>
