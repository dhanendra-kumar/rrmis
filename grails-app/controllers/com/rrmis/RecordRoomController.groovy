...
class RecordRoomController {
    ...
    def fetchAllRecordRoomByOfficeId(Long id) {
        Office office = Office.findById(id)
        List<RecordRoom> recordRooms = RecordRoom.findAllByOffice(office)
        render view: "selectBox", model: [recordRooms: recordRooms]
    }
}
